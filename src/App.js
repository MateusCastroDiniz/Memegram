...
const Carousel = () => {
  const listaUsu = users.map(user => 
    ...
    <li key={user.name} className='user-avatar d-flex flex-column align-items-center'>
      <a href="">
        <img
...
return (
<div id='nav-usu' className='container mt-3 p-0 rounded align-items-center'>
